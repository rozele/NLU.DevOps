...
namespace NLU.DevOps.Luis
{
    ...
    public interface ILuisBatchTestClient
    {
        ...
        Task<string> CreateEvaluationsOperationAsync(JToken batchInput, CancellationToken cancellationToken);
        ...
        Task<string> GetEvaluationsStatusAsync(string operationId, CancellationToken cancellationToken);
